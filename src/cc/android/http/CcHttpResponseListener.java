 ...
 *
 */
public abstract class CcHttpResponseListener {
	...
	public void sendStartMessage() {
		sendMessage(obtainMessage(CcHttpClient.START_MESSAGE, null));
	}
	...
	public void sendFinishMessage() {
		sendMessage(obtainMessage(CcHttpClient.FINISH_MESSAGE, null));
	}
	...
	public void sendProgressMessage(int bytesWritten, int totalSize) {
		sendMessage(obtainMessage(CcHttpClient.PROGRESS_MESSAGE, new Object[] {
	...
	public void sendRetryMessage() {
		sendMessage(obtainMessage(CcHttpClient.RETRY_MESSAGE, null));
	}
