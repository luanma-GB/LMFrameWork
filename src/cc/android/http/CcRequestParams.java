...
public class CcRequestParams {
	 ...
	 *            the source
	 */
	public CcRequestParams(Map<String, String> source) {
		init();
	 ...
	 *            the value
	 */
	public CcRequestParams(String key, String value) {
		init();
		put(key, value);
	}
	 ...
	 */
	public HttpEntity getEntity(CcHttpResponseListener responseListener)
			throws IOException {
	...
	private HttpEntity createMultipartEntity(
			CcHttpResponseListener responseListener) throws IOException {
		CcMultipartEntity entity = new CcMultipartEntity(responseListener);
