 ...
 *   View backgroundShapeView = layout.findViewById(R.id.backgroundShape);
        ...
        backgroundShapeBadge.setBackground(12, Color.parseColor("#9b2eef"));//backgroundDrawableBadge.setBackgroundResource(R.drawable.badge_blue);
